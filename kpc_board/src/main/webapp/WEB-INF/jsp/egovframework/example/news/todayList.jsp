...
<%@ include file="../_inc/TAMO_sub.jsp" %>
	...
	<ul>
...
</div>		<div class="right list news_list">
			<div class="bbs_list">
							<p class="news_tit"><span>월 일</span> ESG 뉴스 스크랩</p>
			<div class="list_top">
			...
			<p class="pagination" style="margin-top:20px">
				<a href="./todayList.php?sch_field=&sch_word=&sch_use_yn=&size=10&page=1" alt="처음페이지로 이동" class="prev end">처음</a>
				<a href="./todayList.php?sch_field=&sch_word=&sch_use_yn=&size=10&page=0" alt="이전페이지로 이동" class="prev">이전</a>
								<a href="./todayList.php?sch_field=&sch_word=&sch_use_yn=&size=10&page=2" alt="다음페이지로 이동" class="next">다음</a>
				<a href="./todayList.php?sch_field=&sch_word=&sch_use_yn=&size=10&page=0" alt="끝페이지로 이동" class="next end">마지막</a>
			</p>
