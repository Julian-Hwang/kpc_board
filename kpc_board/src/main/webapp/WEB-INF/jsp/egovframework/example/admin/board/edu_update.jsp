				...
				<!--<form name="frm" id="frm" method="post" action="edu_proc.php" enctype="multipart/form-data"> -->
					...
					<table class="bbs_write">
						...
						<tr>
							...
							<td>
								<input class="nor" type="text" name="subject" id="subject" value="${vo.title}" style="width:1200px" msg="제목을"/>
							</td>
						</tr>
						<tr>
							<th>썸네일 이미지</th>
							<td>
								<p><input type='file' value="${vo.image}"  name='img_1' style='height:25px;padding:0 0 0 0;' /></p>	
						...
						<tr>
							...
							<td>
								...
								<input class="nor" type="text" name="link_url" id="link_url" placeholder="https://www.naver.com" value="${vo.url}" style="width:1200px" msg="제목을"/>
						...
						<tr>
							...
							<td>
								<input class="nor datepicker" type="text" name="board_sdate" id="board_sdate" value="${vo.statedate1}" style="width:100px" msg="제목을"/>
								~
								<input class="nor datepicker" type="text" name="board_edate" id="board_edate" value="${vo.statedate2}" style="width:100px" msg="제목을"/>
							</td>
						</tr>
						<tr>
							<th>사용여부<span class="star">*</span></th>
							<td>
								<select name="use_yn" id="use_yn" value="${vo.useyn}">
